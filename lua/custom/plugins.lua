  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<F5>', function() require('telescope').extensions.dap.configurations {} end,
        _opts("Load DAP Configurations"))
      vim.keymap.set('n', '<Leader>da', function() require('dap').continue() end, _opts("DAP Continue"))
      vim.keymap.set('n', '<F10>', function() require('dap').step_over() end, _opts("DAP Step Over"))
      vim.keymap.set('n', '<F11>', function() require('dap').step_into() end, _opts("DAP Step Into"))
      vim.keymap.set('n', '<F12>', function() require('dap').step_out() end, _opts("DAP Step Out"))
      vim.keymap.set('n', '<Leader>db', function() require('dap').toggle_breakpoint() end, _opts("Toggle DAP Breakpoint"))
      -- vim.keymap.set('n', '<Leader>B', function() require('dap').set_breakpoint() end, _opts("Set DAP Breakpoint"))
      vim.keymap.set('n', '<Leader>lp',
        function() require('dap').set_breakpoint(nil, nil, vim.fn.input('Log point message: ')) end,
        _opts("Set DAP Logpoint"))
      vim.keymap.set('n', '<Leader>dr', function() require('dap').repl.open() end, _opts("Open DAP REPL"))
      vim.keymap.set('n', '<Leader>dl', function() require('dap').run_last() end, _opts("Run Last DAP"))
      vim.keymap.set({ 'n', 'v' }, '<Leader>dh', function() require('dap.ui.widgets').hover() end, _opts("DAP Hover"))
      vim.keymap.set({ 'n', 'v' }, '<Leader>dp', function() require('dap.ui.widgets').preview() end, _opts("DAP Preview"))
